...
use Mailchimp\Reporting\Types\ListFacebookAdEcommerceProductActivityReportingRequestSortField;

class ListFacebookAdEcommerceProductActivityReportingRequest extends JsonSerializableType
{
    /**
    ...
    /**
     * @var ?value-of<ListFacebookAdEcommerceProductActivityReportingRequestSortField> $sortField Returns files sorted by the specified field.
     */
     ...
     *   count?: ?int,
     *   offset?: ?int,
     *   sortField?: ?value-of<ListFacebookAdEcommerceProductActivityReportingRequestSortField>,
     * } $values
     */
