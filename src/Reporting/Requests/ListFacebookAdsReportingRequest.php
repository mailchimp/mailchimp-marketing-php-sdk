...
use Mailchimp\Reporting\Types\ListFacebookAdsReportingRequestSortField;
use Mailchimp\Reporting\Types\ListFacebookAdsReportingRequestSortDir;

class ListFacebookAdsReportingRequest extends JsonSerializableType
{
    /**
    ...
    /**
     * @var ?value-of<ListFacebookAdsReportingRequestSortField> $sortField Returns files sorted by the specified field.
     */
    public ?string $sortField;

    /**
     * @var ?value-of<ListFacebookAdsReportingRequestSortDir> $sortDir Determines the order direction for sorted results.
     */
     ...
     *   count?: ?int,
     *   offset?: ?int,
     *   sortField?: ?value-of<ListFacebookAdsReportingRequestSortField>,
     *   sortDir?: ?value-of<ListFacebookAdsReportingRequestSortDir>,
     * } $values
     */
