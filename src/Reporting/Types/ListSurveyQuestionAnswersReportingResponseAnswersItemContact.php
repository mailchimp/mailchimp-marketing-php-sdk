 ...
 */
class ListSurveyQuestionAnswersReportingResponseAnswersItemContact extends JsonSerializableType
{
    /**
    ...
    /**
     * @var ?value-of<ListSurveyQuestionAnswersReportingResponseAnswersItemContactStatus> $status The contact's current status.
     */
    #[JsonProperty('status')]
     ...
     *   fullName?: ?string,
     *   phone?: ?string,
     *   status?: ?value-of<ListSurveyQuestionAnswersReportingResponseAnswersItemContactStatus>,
     * } $values
     */
