 ...
 */
class GetSurveyResponsReportingResponseContact extends JsonSerializableType
{
    /**
    ...
    /**
     * @var ?value-of<GetSurveyResponsReportingResponseContactStatus> $status The contact's current status.
     */
    #[JsonProperty('status')]
     ...
     *   fullName?: ?string,
     *   phone?: ?string,
     *   status?: ?value-of<GetSurveyResponsReportingResponseContactStatus>,
     * } $values
     */
