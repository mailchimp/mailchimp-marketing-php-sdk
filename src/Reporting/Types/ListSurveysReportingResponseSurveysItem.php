 ...
 */
class ListSurveysReportingResponseSurveysItem extends JsonSerializableType
{
    /**
    ...
    /**
     * @var ?value-of<ListSurveysReportingResponseSurveysItemStatus> $status The survey's status.
     */
    #[JsonProperty('status')]
     ...
     *   status?: ?value-of<ListSurveysReportingResponseSurveysItemStatus>,
     *   title?: ?string,
     *   totalResponses?: ?int,
     *   updatedAt?: ?DateTime,
     *   url?: ?string,
