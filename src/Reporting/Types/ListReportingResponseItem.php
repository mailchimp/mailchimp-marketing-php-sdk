 ...
 */
class ListReportingResponseItem extends JsonSerializableType
{
    /**
    ...
    /**
     * @var ?value-of<ListReportingResponseItemMethod> $method The HTTP method that should be used when accessing the URL defined in 'href'.
     */
    #[JsonProperty('method')]
     ...
     * @param array{
     *   href?: ?string,
     *   method?: ?value-of<ListReportingResponseItemMethod>,
     *   rel?: ?string,
     *   schema?: ?string,
     *   targetSchema?: ?string,
     * } $values
