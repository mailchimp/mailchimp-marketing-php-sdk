 ...
 */
class ListBatchesResponseLinksItem extends JsonSerializableType
{
    /**
    ...
    /**
     * @var ?value-of<ListBatchesResponseLinksItemMethod> $method The HTTP method that should be used when accessing the URL defined in 'href'.
     */
    #[JsonProperty('method')]
     ...
     * @param array{
     *   href?: ?string,
     *   method?: ?value-of<ListBatchesResponseLinksItemMethod>,
     *   rel?: ?string,
     *   schema?: ?string,
     *   targetSchema?: ?string,
     * } $values
