 ...
 */
class CampaignsRecipients extends JsonSerializableType
{
    /**
    ...
    /**
     * @var ?CampaignsRecipientsSegmentOpts $segmentOpts An object representing all segmentation options. This object should contain a `saved_segment_id` to use an existing segment, or you can create a new segment by including both `match` and `conditions` options.
     */
    #[JsonProperty('segment_opts')]
    public ?CampaignsRecipientsSegmentOpts $segmentOpts;

    /**
     * @var ?string $segmentText A description of the [segment](https://mailchimp.com/help/create-and-send-to-a-segment/) used for the campaign. Formatted as a string marked up with HTML.
     */
     ...
     *   listName?: ?string,
     *   recipientCount?: ?int,
     *   segmentOpts?: ?CampaignsRecipientsSegmentOpts,
     *   segmentText?: ?string,
     * } $values
     */
