 ...
 */
class AutomationWorkflowLinksItem extends JsonSerializableType
{
    /**
    ...
    /**
     * @var ?value-of<AutomationWorkflowLinksItemMethod> $method The HTTP method that should be used when accessing the URL defined in 'href'.
     */
    #[JsonProperty('method')]
     ...
     * @param array{
     *   href?: ?string,
     *   method?: ?value-of<AutomationWorkflowLinksItemMethod>,
     *   rel?: ?string,
     *   schema?: ?string,
     *   targetSchema?: ?string,
     * } $values
