 ...
 */
class ECommercePromoRuleLinksItem extends JsonSerializableType
{
    /**
    ...
    /**
     * @var ?value-of<ECommercePromoRuleLinksItemMethod> $method The HTTP method that should be used when accessing the URL defined in 'href'.
     */
    #[JsonProperty('method')]
     ...
     * @param array{
     *   href?: ?string,
     *   method?: ?value-of<ECommercePromoRuleLinksItemMethod>,
     *   rel?: ?string,
     *   schema?: ?string,
     *   targetSchema?: ?string,
     * } $values
