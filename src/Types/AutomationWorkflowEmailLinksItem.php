 ...
 */
class AutomationWorkflowEmailLinksItem extends JsonSerializableType
{
    /**
    ...
    /**
     * @var ?value-of<AutomationWorkflowEmailLinksItemMethod> $method The HTTP method that should be used when accessing the URL defined in 'href'.
     */
    #[JsonProperty('method')]
     ...
     * @param array{
     *   href?: ?string,
     *   method?: ?value-of<AutomationWorkflowEmailLinksItemMethod>,
     *   rel?: ?string,
     *   schema?: ?string,
     *   targetSchema?: ?string,
     * } $values
