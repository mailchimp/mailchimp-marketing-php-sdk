 ...
 */
class GalleryFileLinksItem extends JsonSerializableType
{
    /**
    ...
    /**
     * @var ?value-of<GalleryFileLinksItemMethod> $method The HTTP method that should be used when accessing the URL defined in 'href'.
     */
    #[JsonProperty('method')]
     ...
     * @param array{
     *   href?: ?string,
     *   method?: ?value-of<GalleryFileLinksItemMethod>,
     *   rel?: ?string,
     *   schema?: ?string,
     *   targetSchema?: ?string,
     * } $values
