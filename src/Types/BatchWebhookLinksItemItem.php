 ...
 */
class BatchWebhookLinksItemItem extends JsonSerializableType
{
    /**
    ...
    /**
     * @var ?value-of<BatchWebhookLinksItemItemMethod> $method The HTTP method that should be used when accessing the URL defined in 'href'.
     */
    #[JsonProperty('method')]
     ...
     * @param array{
     *   href?: ?string,
     *   method?: ?value-of<BatchWebhookLinksItemItemMethod>,
     *   rel?: ?string,
     *   schema?: ?string,
     *   targetSchema?: ?string,
     * } $values
