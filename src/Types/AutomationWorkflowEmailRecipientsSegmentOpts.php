 ...
 */
class AutomationWorkflowEmailRecipientsSegmentOpts extends JsonSerializableType
{
    /**
    ...
    /**
     * @var ?value-of<AutomationWorkflowEmailRecipientsSegmentOptsMatch> $match Segment match type.
     */
    #[JsonProperty('match')]
    public ?string $match;
     ...
     *   match?: ?value-of<AutomationWorkflowEmailRecipientsSegmentOptsMatch>,
