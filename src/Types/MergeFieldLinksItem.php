 ...
 */
class MergeFieldLinksItem extends JsonSerializableType
{
    /**
    ...
    /**
     * @var ?value-of<MergeFieldLinksItemMethod> $method The HTTP method that should be used when accessing the URL defined in 'href'.
     */
    #[JsonProperty('method')]
     ...
     * @param array{
     *   href?: ?string,
     *   method?: ?value-of<MergeFieldLinksItemMethod>,
     *   rel?: ?string,
     *   schema?: ?string,
     *   targetSchema?: ?string,
     * } $values
