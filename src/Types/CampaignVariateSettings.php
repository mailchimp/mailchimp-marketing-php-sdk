 ...
 */
class CampaignVariateSettings extends JsonSerializableType
{
    /**
     * @var ?array<CampaignVariateSettingsCombinationsItem> $combinations Combinations of possible variables used to build emails.
     */
    #[JsonProperty('combinations'), ArrayType([CampaignVariateSettingsCombinationsItem::class])]
    ...
    /**
     * @var value-of<CampaignVariateSettingsWinnerCriteria> $winnerCriteria The combination that performs the best. This may be determined automatically by click rate, open rate, or total revenue -- or you may choose manually based on the reporting data you find the most valuable. For Multivariate Campaigns testing send_time, winner_criteria is ignored. For Multivariate Campaigns with 'manual' as the winner_criteria, the winner must be chosen in the Mailchimp web application.
     */
    ...
    /**
     * @param array{
     *   winnerCriteria: value-of<CampaignVariateSettingsWinnerCriteria>,
     *   combinations?: ?array<CampaignVariateSettingsCombinationsItem>,
