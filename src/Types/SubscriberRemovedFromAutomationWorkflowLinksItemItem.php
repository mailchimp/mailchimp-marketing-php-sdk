 ...
 */
class SubscriberRemovedFromAutomationWorkflowLinksItemItem extends JsonSerializableType
{
    /**
    ...
    /**
     * @var ?value-of<SubscriberRemovedFromAutomationWorkflowLinksItemItemMethod> $method The HTTP method that should be used when accessing the URL defined in 'href'.
     */
    #[JsonProperty('method')]
     ...
     * @param array{
     *   href?: ?string,
     *   method?: ?value-of<SubscriberRemovedFromAutomationWorkflowLinksItemItemMethod>,
     *   rel?: ?string,
     *   schema?: ?string,
     *   targetSchema?: ?string,
     * } $values
