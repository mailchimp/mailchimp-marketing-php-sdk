 ...
 */
class CampaignReportDeliveryStatus extends JsonSerializableType
{
    /**
    ...
    /**
     * @var ?value-of<CampaignReportDeliveryStatusStatus> $status The current state of a campaign delivery.
     */
    #[JsonProperty('status')]
     ...
     *   emailsSent?: ?int,
     *   enabled?: ?bool,
     *   status?: ?value-of<CampaignReportDeliveryStatusStatus>,
     * } $values
     */
