 ...
 */
class FacebookAdRecipients extends JsonSerializableType
{
    /**
    ...
    /**
     * @var ?FacebookAdRecipientsSegmentOpts $segmentOpts An object representing all segmentation options. This object should contain a `saved_segment_id` to use an existing segment, or you can create a new segment by including both `match` and `conditions` options.
     */
    #[JsonProperty('segment_opts')]
    public ?FacebookAdRecipientsSegmentOpts $segmentOpts;
     ...
     *   listName?: ?string,
     *   recipientCount?: ?int,
     *   segmentOpts?: ?FacebookAdRecipientsSegmentOpts,
     *   segmentText?: ?string,
     * } $values
     */
