 ...
 */
class SmsCampaignContentLinksItem extends JsonSerializableType
{
    /**
    ...
    /**
     * @var ?value-of<SmsCampaignContentLinksItemMethod> $method The HTTP method that should be used when accessing the URL defined in 'href'.
     */
    #[JsonProperty('method')]
     ...
     * @param array{
     *   href?: ?string,
     *   method?: ?value-of<SmsCampaignContentLinksItemMethod>,
     *   rel?: ?string,
     *   schema?: ?string,
     *   targetSchema?: ?string,
     * } $values
