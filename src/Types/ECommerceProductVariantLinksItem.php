 ...
 */
class ECommerceProductVariantLinksItem extends JsonSerializableType
{
    /**
    ...
    /**
     * @var ?value-of<ECommerceProductVariantLinksItemMethod> $method The HTTP method that should be used when accessing the URL defined in 'href'.
     */
    #[JsonProperty('method')]
     ...
     * @param array{
     *   href?: ?string,
     *   method?: ?value-of<ECommerceProductVariantLinksItemMethod>,
     *   rel?: ?string,
     *   schema?: ?string,
     *   targetSchema?: ?string,
     * } $values
