 ...
 */
class SubscriberInAutomationQueueLinksItemItem extends JsonSerializableType
{
    /**
    ...
    /**
     * @var ?value-of<SubscriberInAutomationQueueLinksItemItemMethod> $method The HTTP method that should be used when accessing the URL defined in 'href'.
     */
    #[JsonProperty('method')]
     ...
     * @param array{
     *   href?: ?string,
     *   method?: ?value-of<SubscriberInAutomationQueueLinksItemItemMethod>,
     *   rel?: ?string,
     *   schema?: ?string,
     *   targetSchema?: ?string,
     * } $values
