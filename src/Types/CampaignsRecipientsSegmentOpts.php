 ...
 */
class CampaignsRecipientsSegmentOpts extends JsonSerializableType
{
    /**
    ...
    /**
     * @var ?value-of<CampaignsRecipientsSegmentOptsMatch> $match Segment match type.
     */
    #[JsonProperty('match')]
    public ?string $match;
     ...
     *   match?: ?value-of<CampaignsRecipientsSegmentOptsMatch>,
