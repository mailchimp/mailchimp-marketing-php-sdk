 ...
 */
class LandingPageReportLinksItem extends JsonSerializableType
{
    /**
    ...
    /**
     * @var ?value-of<LandingPageReportLinksItemMethod> $method The HTTP method that should be used when accessing the URL defined in 'href'.
     */
    #[JsonProperty('method')]
     ...
     * @param array{
     *   href?: ?string,
     *   method?: ?value-of<LandingPageReportLinksItemMethod>,
     *   rel?: ?string,
     *   schema?: ?string,
     *   targetSchema?: ?string,
     * } $values
