 ...
 */
class EmailActivityLinksItem extends JsonSerializableType
{
    /**
    ...
    /**
     * @var ?value-of<EmailActivityLinksItemMethod> $method The HTTP method that should be used when accessing the URL defined in 'href'.
     */
    #[JsonProperty('method')]
     ...
     * @param array{
     *   href?: ?string,
     *   method?: ?value-of<EmailActivityLinksItemMethod>,
     *   rel?: ?string,
     *   schema?: ?string,
     *   targetSchema?: ?string,
     * } $values
