 ...
 */
class CampaignContentLinksItem extends JsonSerializableType
{
    /**
    ...
    /**
     * @var ?value-of<CampaignContentLinksItemMethod> $method The HTTP method that should be used when accessing the URL defined in 'href'.
     */
    #[JsonProperty('method')]
     ...
     * @param array{
     *   href?: ?string,
     *   method?: ?value-of<CampaignContentLinksItemMethod>,
     *   rel?: ?string,
     *   schema?: ?string,
     *   targetSchema?: ?string,
     * } $values
