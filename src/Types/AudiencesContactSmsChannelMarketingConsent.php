 ...
 */
class AudiencesContactSmsChannelMarketingConsent extends JsonSerializableType
{
    /**
     * @var ?AudiencesContactSmsChannelMarketingConsentSource $source The source from which the parent's entity was created.
     */
    #[JsonProperty('source')]
    public ?AudiencesContactSmsChannelMarketingConsentSource $source;

    /**
     * @var ?value-of<AudiencesContactSmsChannelMarketingConsentStatus> $status The contact's SMS marketing consent status. Use `confirmed` for double opt-in audiences, `consented` for single opt-in audiences. `denied` is accepted on PATCH/PUT only (not POST) and drives an API-initiated unsubscribe; it cannot be used when creating a new contact.
     */
    #[JsonProperty('status')]
    ...
    /**
     * @param array{
     *   source?: ?AudiencesContactSmsChannelMarketingConsentSource,
     *   status?: ?value-of<AudiencesContactSmsChannelMarketingConsentStatus>,
     *   capturedAt?: ?DateTime,
     * } $values
     */
