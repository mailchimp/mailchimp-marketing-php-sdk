 ...
 */
class ListsAbuseReportsLinksItem extends JsonSerializableType
{
    /**
    ...
    /**
     * @var ?value-of<ListsAbuseReportsLinksItemMethod> $method The HTTP method that should be used when accessing the URL defined in 'href'.
     */
    #[JsonProperty('method')]
     ...
     * @param array{
     *   href?: ?string,
     *   method?: ?value-of<ListsAbuseReportsLinksItemMethod>,
     *   rel?: ?string,
     *   schema?: ?string,
     *   targetSchema?: ?string,
     * } $values
