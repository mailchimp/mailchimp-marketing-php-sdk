 ...
 */
class CampaignFoldersFoldersItemLinksItem extends JsonSerializableType
{
    /**
    ...
    /**
     * @var ?value-of<CampaignFoldersFoldersItemLinksItemMethod> $method The HTTP method that should be used when accessing the URL defined in 'href'.
     */
    #[JsonProperty('method')]
     ...
     * @param array{
     *   href?: ?string,
     *   method?: ?value-of<CampaignFoldersFoldersItemLinksItemMethod>,
     *   rel?: ?string,
     *   schema?: ?string,
     *   targetSchema?: ?string,
     * } $values
