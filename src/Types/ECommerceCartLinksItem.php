 ...
 */
class ECommerceCartLinksItem extends JsonSerializableType
{
    /**
    ...
    /**
     * @var ?value-of<ECommerceCartLinksItemMethod> $method The HTTP method that should be used when accessing the URL defined in 'href'.
     */
    #[JsonProperty('method')]
     ...
     * @param array{
     *   href?: ?string,
     *   method?: ?value-of<ECommerceCartLinksItemMethod>,
     *   rel?: ?string,
     *   schema?: ?string,
     *   targetSchema?: ?string,
     * } $values
