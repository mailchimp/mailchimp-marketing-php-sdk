 ...
 */
class LandingPageLinksItem extends JsonSerializableType
{
    /**
    ...
    /**
     * @var ?value-of<LandingPageLinksItemMethod> $method The HTTP method that should be used when accessing the URL defined in 'href'.
     */
    #[JsonProperty('method')]
     ...
     * @param array{
     *   href?: ?string,
     *   method?: ?value-of<LandingPageLinksItemMethod>,
     *   rel?: ?string,
     *   schema?: ?string,
     *   targetSchema?: ?string,
     * } $values
