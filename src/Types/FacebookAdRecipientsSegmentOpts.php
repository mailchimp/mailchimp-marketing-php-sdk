 ...
 */
class FacebookAdRecipientsSegmentOpts extends JsonSerializableType
{
    /**
    ...
    /**
     * @var ?value-of<FacebookAdRecipientsSegmentOptsMatch> $match Segment match type.
     */
    #[JsonProperty('match')]
    public ?string $match;
     ...
     *   match?: ?value-of<FacebookAdRecipientsSegmentOptsMatch>,
