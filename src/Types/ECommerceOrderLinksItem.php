 ...
 */
class ECommerceOrderLinksItem extends JsonSerializableType
{
    /**
    ...
    /**
     * @var ?value-of<ECommerceOrderLinksItemMethod> $method The HTTP method that should be used when accessing the URL defined in 'href'.
     */
    #[JsonProperty('method')]
     ...
     * @param array{
     *   href?: ?string,
     *   method?: ?value-of<ECommerceOrderLinksItemMethod>,
     *   rel?: ?string,
     *   schema?: ?string,
     *   targetSchema?: ?string,
     * } $values
