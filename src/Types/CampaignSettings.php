 ...
 */
class CampaignSettings extends JsonSerializableType
{
    /**
    ...
    /**
     * @var ?bool $timewarp Send this campaign using [Timewarp](https://mailchimp.com/help/use-timewarp/).
     */
    ...
    /**
     * @var ?bool $useConversation Use Mailchimp Conversation feature to manage replies.
     */
