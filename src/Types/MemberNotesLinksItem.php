 ...
 */
class MemberNotesLinksItem extends JsonSerializableType
{
    /**
    ...
    /**
     * @var ?value-of<MemberNotesLinksItemMethod> $method The HTTP method that should be used when accessing the URL defined in 'href'.
     */
    #[JsonProperty('method')]
     ...
     * @param array{
     *   href?: ?string,
     *   method?: ?value-of<MemberNotesLinksItemMethod>,
     *   rel?: ?string,
     *   schema?: ?string,
     *   targetSchema?: ?string,
     * } $values
