 ...
 */
class SignupFormLinksItem extends JsonSerializableType
{
    /**
    ...
    /**
     * @var ?value-of<SignupFormLinksItemMethod> $method The HTTP method that should be used when accessing the URL defined in 'href'.
     */
    #[JsonProperty('method')]
     ...
     * @param array{
     *   href?: ?string,
     *   method?: ?value-of<SignupFormLinksItemMethod>,
     *   rel?: ?string,
     *   schema?: ?string,
     *   targetSchema?: ?string,
     * } $values
