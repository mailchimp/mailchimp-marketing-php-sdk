 ...
 */
class ListsSegmentsMembersLinksItem extends JsonSerializableType
{
    /**
    ...
    /**
     * @var ?value-of<ListsSegmentsMembersLinksItemMethod> $method The HTTP method that should be used when accessing the URL defined in 'href'.
     */
    #[JsonProperty('method')]
     ...
     * @param array{
     *   href?: ?string,
     *   method?: ?value-of<ListsSegmentsMembersLinksItemMethod>,
     *   rel?: ?string,
     *   schema?: ?string,
     *   targetSchema?: ?string,
     * } $values
