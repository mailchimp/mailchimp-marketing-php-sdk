 ...
 */
class CampaignReportLinksItem extends JsonSerializableType
{
    /**
    ...
    /**
     * @var ?value-of<CampaignReportLinksItemMethod> $method The HTTP method that should be used when accessing the URL defined in 'href'.
     */
    #[JsonProperty('method')]
     ...
     * @param array{
     *   href?: ?string,
     *   method?: ?value-of<CampaignReportLinksItemMethod>,
     *   rel?: ?string,
     *   schema?: ?string,
     *   targetSchema?: ?string,
     * } $values
