 ...
 */
class ECommerceOrderLineItemLinksItem extends JsonSerializableType
{
    /**
    ...
    /**
     * @var ?value-of<ECommerceOrderLineItemLinksItemMethod> $method The HTTP method that should be used when accessing the URL defined in 'href'.
     */
    #[JsonProperty('method')]
     ...
     * @param array{
     *   href?: ?string,
     *   method?: ?value-of<ECommerceOrderLineItemLinksItemMethod>,
     *   rel?: ?string,
     *   schema?: ?string,
     *   targetSchema?: ?string,
     * } $values
