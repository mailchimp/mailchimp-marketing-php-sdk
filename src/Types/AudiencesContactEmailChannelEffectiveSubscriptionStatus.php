 ...
 */
class AudiencesContactEmailChannelEffectiveSubscriptionStatus extends JsonSerializableType
{
    /**
     * @var ?value-of<AudiencesContactEmailChannelEffectiveSubscriptionStatusValue> $value
     */
    #[JsonProperty('value')]
    public ?string $value;
    ...
    /**
     * @param array{
     *   value?: ?value-of<AudiencesContactEmailChannelEffectiveSubscriptionStatusValue>,
     * } $values
     */
