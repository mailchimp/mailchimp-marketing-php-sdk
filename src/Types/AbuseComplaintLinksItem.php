 ...
 */
class AbuseComplaintLinksItem extends JsonSerializableType
{
    /**
    ...
    /**
     * @var ?value-of<AbuseComplaintLinksItemMethod> $method The HTTP method that should be used when accessing the URL defined in 'href'.
     */
    #[JsonProperty('method')]
     ...
     * @param array{
     *   href?: ?string,
     *   method?: ?value-of<AbuseComplaintLinksItemMethod>,
     *   rel?: ?string,
     *   schema?: ?string,
     *   targetSchema?: ?string,
     * } $values
