 ...
 */
class CampaignFeedback extends JsonSerializableType
{
    /**
     * @var ?array<CampaignFeedbackLinksItem> $links A list of link types and descriptions for the API schema documents.
     */
    #[JsonProperty('_links'), ArrayType([CampaignFeedbackLinksItem::class])]
    public ?array $links;
    ...
    /**
     * @var ?value-of<CampaignFeedbackSource> $source The source of the feedback.
     */
    #[JsonProperty('source')]
    ...
    /**
     * @param array{
     *   links?: ?array<CampaignFeedbackLinksItem>,
     *   blockId?: ?int,
     *   campaignId?: ?string,
     *   createdAt?: ?DateTime,
     *   createdBy?: ?string,
     ...
     *   message?: ?string,
     *   parentId?: ?int,
     *   source?: ?value-of<CampaignFeedbackSource>,
     *   updatedAt?: ?DateTime,
     * } $values
     */
