 ...
 */
class ListWebhooksLinksItem extends JsonSerializableType
{
    /**
    ...
    /**
     * @var ?value-of<ListWebhooksLinksItemMethod> $method The HTTP method that should be used when accessing the URL defined in 'href'.
     */
    #[JsonProperty('method')]
     ...
     * @param array{
     *   href?: ?string,
     *   method?: ?value-of<ListWebhooksLinksItemMethod>,
     *   rel?: ?string,
     *   schema?: ?string,
     *   targetSchema?: ?string,
     * } $values
