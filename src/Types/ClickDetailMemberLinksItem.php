 ...
 */
class ClickDetailMemberLinksItem extends JsonSerializableType
{
    /**
    ...
    /**
     * @var ?value-of<ClickDetailMemberLinksItemMethod> $method The HTTP method that should be used when accessing the URL defined in 'href'.
     */
    #[JsonProperty('method')]
     ...
     * @param array{
     *   href?: ?string,
     *   method?: ?value-of<ClickDetailMemberLinksItemMethod>,
     *   rel?: ?string,
     *   schema?: ?string,
     *   targetSchema?: ?string,
     * } $values
