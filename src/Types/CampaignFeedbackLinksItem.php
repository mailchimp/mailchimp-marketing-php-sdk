 ...
 */
class CampaignFeedbackLinksItem extends JsonSerializableType
{
    /**
    ...
    /**
     * @var ?value-of<CampaignFeedbackLinksItemMethod> $method The HTTP method that should be used when accessing the URL defined in 'href'.
     */
    #[JsonProperty('method')]
     ...
     * @param array{
     *   href?: ?string,
     *   method?: ?value-of<CampaignFeedbackLinksItemMethod>,
     *   rel?: ?string,
     *   schema?: ?string,
     *   targetSchema?: ?string,
     * } $values
