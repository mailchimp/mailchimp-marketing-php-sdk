 ...
 */
class UnsubscribesLinksItem extends JsonSerializableType
{
    /**
    ...
    /**
     * @var ?value-of<UnsubscribesLinksItemMethod> $method The HTTP method that should be used when accessing the URL defined in 'href'.
     */
    #[JsonProperty('method')]
     ...
     * @param array{
     *   href?: ?string,
     *   method?: ?value-of<UnsubscribesLinksItemMethod>,
     *   rel?: ?string,
     *   schema?: ?string,
     *   targetSchema?: ?string,
     * } $values
