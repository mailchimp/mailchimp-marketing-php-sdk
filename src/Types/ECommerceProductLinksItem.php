 ...
 */
class ECommerceProductLinksItem extends JsonSerializableType
{
    /**
    ...
    /**
     * @var ?value-of<ECommerceProductLinksItemMethod> $method The HTTP method that should be used when accessing the URL defined in 'href'.
     */
    #[JsonProperty('method')]
     ...
     * @param array{
     *   href?: ?string,
     *   method?: ?value-of<ECommerceProductLinksItemMethod>,
     *   rel?: ?string,
     *   schema?: ?string,
     *   targetSchema?: ?string,
     * } $values
