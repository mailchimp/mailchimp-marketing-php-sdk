 ...
 */
class ClickDetailReportLinksItem extends JsonSerializableType
{
    /**
    ...
    /**
     * @var ?value-of<ClickDetailReportLinksItemMethod> $method The HTTP method that should be used when accessing the URL defined in 'href'.
     */
    #[JsonProperty('method')]
     ...
     * @param array{
     *   href?: ?string,
     *   method?: ?value-of<ClickDetailReportLinksItemMethod>,
     *   rel?: ?string,
     *   schema?: ?string,
     *   targetSchema?: ?string,
     * } $values
