 ...
 */
class InterestCategoryLinksItem extends JsonSerializableType
{
    /**
    ...
    /**
     * @var ?value-of<InterestCategoryLinksItemMethod> $method The HTTP method that should be used when accessing the URL defined in 'href'.
     */
    #[JsonProperty('method')]
     ...
     * @param array{
     *   href?: ?string,
     *   method?: ?value-of<InterestCategoryLinksItemMethod>,
     *   rel?: ?string,
     *   schema?: ?string,
     *   targetSchema?: ?string,
     * } $values
