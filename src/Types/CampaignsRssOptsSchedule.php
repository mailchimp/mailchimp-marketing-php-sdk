 ...
 */
class CampaignsRssOptsSchedule extends JsonSerializableType
{
    /**
     * @var ?CampaignsRssOptsScheduleDailySend $dailySend The days of the week to send a daily RSS Campaign.
     */
    #[JsonProperty('daily_send')]
    public ?CampaignsRssOptsScheduleDailySend $dailySend;
    ...
    /**
     * @var ?value-of<CampaignsRssOptsScheduleWeeklySendDay> $weeklySendDay The day of the week to send a weekly RSS Campaign.
     */
    ...
    /**
     * @param array{
     *   dailySend?: ?CampaignsRssOptsScheduleDailySend,
     *   hour?: ?int,
     *   monthlySendDate?: ?float,
     *   weeklySendDay?: ?value-of<CampaignsRssOptsScheduleWeeklySendDay>,
     * } $values
     */
