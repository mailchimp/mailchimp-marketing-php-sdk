 ...
 */
class ConnectedSiteLinksItem extends JsonSerializableType
{
    /**
    ...
    /**
     * @var ?value-of<ConnectedSiteLinksItemMethod> $method The HTTP method that should be used when accessing the URL defined in 'href'.
     */
    #[JsonProperty('method')]
     ...
     * @param array{
     *   href?: ?string,
     *   method?: ?value-of<ConnectedSiteLinksItemMethod>,
     *   rel?: ?string,
     *   schema?: ?string,
     *   targetSchema?: ?string,
     * } $values
