 ...
 */
class TemplateInstanceLinksItem extends JsonSerializableType
{
    /**
    ...
    /**
     * @var ?value-of<TemplateInstanceLinksItemMethod> $method The HTTP method that should be used when accessing the URL defined in 'href'.
     */
    #[JsonProperty('method')]
     ...
     * @param array{
     *   href?: ?string,
     *   method?: ?value-of<TemplateInstanceLinksItemMethod>,
     *   rel?: ?string,
     *   schema?: ?string,
     *   targetSchema?: ?string,
     * } $values
