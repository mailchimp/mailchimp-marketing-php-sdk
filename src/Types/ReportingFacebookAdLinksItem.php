 ...
 */
class ReportingFacebookAdLinksItem extends JsonSerializableType
{
    /**
    ...
    /**
     * @var ?value-of<ReportingFacebookAdLinksItemMethod> $method The HTTP method that should be used when accessing the URL defined in 'href'.
     */
    #[JsonProperty('method')]
     ...
     * @param array{
     *   href?: ?string,
     *   method?: ?value-of<ReportingFacebookAdLinksItemMethod>,
     *   rel?: ?string,
     *   schema?: ?string,
     *   targetSchema?: ?string,
     * } $values
