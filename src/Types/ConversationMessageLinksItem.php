 ...
 */
class ConversationMessageLinksItem extends JsonSerializableType
{
    /**
    ...
    /**
     * @var ?value-of<ConversationMessageLinksItemMethod> $method The HTTP method that should be used when accessing the URL defined in 'href'.
     */
    #[JsonProperty('method')]
     ...
     * @param array{
     *   href?: ?string,
     *   method?: ?value-of<ConversationMessageLinksItemMethod>,
     *   rel?: ?string,
     *   schema?: ?string,
     *   targetSchema?: ?string,
     * } $values
