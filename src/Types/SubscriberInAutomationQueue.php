 ...
 */
class SubscriberInAutomationQueue extends JsonSerializableType
{
    /**
     * @var ?array<array<SubscriberInAutomationQueueLinksItemItem>> $links A list of link types and descriptions for the API schema documents.
     */
    #[JsonProperty('_links'), ArrayType([[SubscriberInAutomationQueueLinksItemItem::class]])]
    public ?array $links;
    ...
    /**
     * @param array{
     *   links?: ?array<array<SubscriberInAutomationQueueLinksItemItem>>,
     *   emailAddress?: ?string,
     *   emailId?: ?string,
     *   id?: ?string,
     *   listId?: ?string,
