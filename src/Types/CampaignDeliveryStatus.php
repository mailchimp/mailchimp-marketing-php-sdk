 ...
 */
class CampaignDeliveryStatus extends JsonSerializableType
{
    /**
    ...
    /**
     * @var ?value-of<CampaignDeliveryStatusStatus> $status The current state of a campaign delivery.
     */
    #[JsonProperty('status')]
     ...
     *   emailsSent?: ?int,
     *   enabled?: ?bool,
     *   status?: ?value-of<CampaignDeliveryStatusStatus>,
     * } $values
     */
