 ...
 */
class ListAccountExportsResponseExportsItemLinksItem extends JsonSerializableType
{
    /**
    ...
    /**
     * @var ?value-of<ListAccountExportsResponseExportsItemLinksItemMethod> $method The HTTP method that should be used when accessing the URL defined in 'href'.
     */
    #[JsonProperty('method')]
     ...
     * @param array{
     *   href?: ?string,
     *   method?: ?value-of<ListAccountExportsResponseExportsItemLinksItemMethod>,
     *   rel?: ?string,
     *   schema?: ?string,
     *   targetSchema?: ?string,
     * } $values
