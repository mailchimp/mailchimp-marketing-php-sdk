 ...
 * An account export.
 */
class ListAccountExportsResponseExportsItem extends JsonSerializableType
{
    /**
     * @var ?array<ListAccountExportsResponseExportsItemLinksItem> $links A list of link types and descriptions for the API schema documents.
     */
    #[JsonProperty('_links'), ArrayType([ListAccountExportsResponseExportsItemLinksItem::class])]
    public ?array $links;
    ...
    /**
     * @param array{
     *   links?: ?array<ListAccountExportsResponseExportsItemLinksItem>,
     *   downloadUrl?: ?string,
     *   exportId?: ?int,
     *   finished?: ?DateTime,
     *   sizeInBytes?: ?int,
