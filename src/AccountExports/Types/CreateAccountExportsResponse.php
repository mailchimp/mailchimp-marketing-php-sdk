 ...
 * An account export.
 */
class CreateAccountExportsResponse extends JsonSerializableType
{
    /**
     * @var ?array<CreateAccountExportsResponseLinksItem> $links A list of link types and descriptions for the API schema documents.
     */
    #[JsonProperty('_links'), ArrayType([CreateAccountExportsResponseLinksItem::class])]
    public ?array $links;
    ...
    /**
     * @param array{
     *   links?: ?array<CreateAccountExportsResponseLinksItem>,
     *   downloadUrl?: ?string,
     *   exportId?: ?int,
     *   finished?: ?DateTime,
     *   sizeInBytes?: ?int,
