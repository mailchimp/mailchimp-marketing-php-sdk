 ...
 */
class ListRemovedSubscribersAutomationsResponseLinksItemItem extends JsonSerializableType
{
    /**
    ...
    /**
     * @var ?value-of<ListRemovedSubscribersAutomationsResponseLinksItemItemMethod> $method The HTTP method that should be used when accessing the URL defined in 'href'.
     */
    #[JsonProperty('method')]
     ...
     * @param array{
     *   href?: ?string,
     *   method?: ?value-of<ListRemovedSubscribersAutomationsResponseLinksItemItemMethod>,
     *   rel?: ?string,
     *   schema?: ?string,
     *   targetSchema?: ?string,
     * } $values
