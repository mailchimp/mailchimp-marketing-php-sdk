 ...
 */
class ListEmailsAutomationsResponseLinksItemItem extends JsonSerializableType
{
    /**
    ...
    /**
     * @var ?value-of<ListEmailsAutomationsResponseLinksItemItemMethod> $method The HTTP method that should be used when accessing the URL defined in 'href'.
     */
    #[JsonProperty('method')]
     ...
     * @param array{
     *   href?: ?string,
     *   method?: ?value-of<ListEmailsAutomationsResponseLinksItemItemMethod>,
     *   rel?: ?string,
     *   schema?: ?string,
     *   targetSchema?: ?string,
     * } $values
