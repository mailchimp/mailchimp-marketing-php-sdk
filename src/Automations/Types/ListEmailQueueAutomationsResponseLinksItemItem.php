 ...
 */
class ListEmailQueueAutomationsResponseLinksItemItem extends JsonSerializableType
{
    /**
    ...
    /**
     * @var ?value-of<ListEmailQueueAutomationsResponseLinksItemItemMethod> $method The HTTP method that should be used when accessing the URL defined in 'href'.
     */
    #[JsonProperty('method')]
     ...
     * @param array{
     *   href?: ?string,
     *   method?: ?value-of<ListEmailQueueAutomationsResponseLinksItemItemMethod>,
     *   rel?: ?string,
     *   schema?: ?string,
     *   targetSchema?: ?string,
     * } $values
