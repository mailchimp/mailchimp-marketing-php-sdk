...
namespace Mailchimp\Root;

use Psr\Http\Client\ClientInterface;
use Mailchimp\Core\Client\RawClient;
use Mailchimp\Root\Requests\ListRootRequest;
use Mailchimp\Root\Types\ListRootResponse;
...
class RootClient
{
     ...
     */
    public function list(ListRootRequest $request = new ListRootRequest(), ?array $options = null): ?ListRootResponse
    {
        ...
        try {
            ...
            if ($statusCode >= 200 && $statusCode < 400) {
                ...
                return ListRootResponse::fromJson($json);
            }
