 ...
 */
class BatchSubscribeOrUnsubscribeListsResponseLinksItem extends JsonSerializableType
{
    /**
    ...
    /**
     * @var ?value-of<BatchSubscribeOrUnsubscribeListsResponseLinksItemMethod> $method The HTTP method that should be used when accessing the URL defined in 'href'.
     */
    #[JsonProperty('method')]
     ...
     * @param array{
     *   href?: ?string,
     *   method?: ?value-of<BatchSubscribeOrUnsubscribeListsResponseLinksItemMethod>,
     *   rel?: ?string,
     *   schema?: ?string,
     *   targetSchema?: ?string,
     * } $values
