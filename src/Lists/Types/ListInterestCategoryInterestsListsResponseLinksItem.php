 ...
 */
class ListInterestCategoryInterestsListsResponseLinksItem extends JsonSerializableType
{
    /**
    ...
    /**
     * @var ?value-of<ListInterestCategoryInterestsListsResponseLinksItemMethod> $method The HTTP method that should be used when accessing the URL defined in 'href'.
     */
    #[JsonProperty('method')]
     ...
     * @param array{
     *   href?: ?string,
     *   method?: ?value-of<ListInterestCategoryInterestsListsResponseLinksItemMethod>,
     *   rel?: ?string,
     *   schema?: ?string,
     *   targetSchema?: ?string,
     * } $values
