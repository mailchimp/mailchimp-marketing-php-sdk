 ...
 */
class ListActivityListsResponseActivityItemLinksItem extends JsonSerializableType
{
    /**
    ...
    /**
     * @var ?value-of<ListActivityListsResponseActivityItemLinksItemMethod> $method The HTTP method that should be used when accessing the URL defined in 'href'.
     */
    #[JsonProperty('method')]
     ...
     * @param array{
     *   href?: ?string,
     *   method?: ?value-of<ListActivityListsResponseActivityItemLinksItemMethod>,
     *   rel?: ?string,
     *   schema?: ?string,
     *   targetSchema?: ?string,
     * } $values
