 ...
 */
class BatchAddOrRemoveMembersListsResponseLinksItem extends JsonSerializableType
{
    /**
    ...
    /**
     * @var ?value-of<BatchAddOrRemoveMembersListsResponseLinksItemMethod> $method The HTTP method that should be used when accessing the URL defined in 'href'.
     */
    #[JsonProperty('method')]
     ...
     * @param array{
     *   href?: ?string,
     *   method?: ?value-of<BatchAddOrRemoveMembersListsResponseLinksItemMethod>,
     *   rel?: ?string,
     *   schema?: ?string,
     *   targetSchema?: ?string,
     * } $values
