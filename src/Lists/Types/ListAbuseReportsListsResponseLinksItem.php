 ...
 */
class ListAbuseReportsListsResponseLinksItem extends JsonSerializableType
{
    /**
    ...
    /**
     * @var ?value-of<ListAbuseReportsListsResponseLinksItemMethod> $method The HTTP method that should be used when accessing the URL defined in 'href'.
     */
    #[JsonProperty('method')]
     ...
     * @param array{
     *   href?: ?string,
     *   method?: ?value-of<ListAbuseReportsListsResponseLinksItemMethod>,
     *   rel?: ?string,
     *   schema?: ?string,
     *   targetSchema?: ?string,
     * } $values
