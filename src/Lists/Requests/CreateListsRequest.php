...
use Mailchimp\Lists\Types\CreateListsRequestCampaignDefaults;
use Mailchimp\Core\Json\JsonProperty;
use Mailchimp\Lists\Types\CreateListsRequestContact;

class CreateListsRequest extends JsonSerializableType
{
    /**
     * @var CreateListsRequestCampaignDefaults $campaignDefaults [Default values for campaigns](https://mailchimp.com/help/edit-your-emails-subject-preview-text-from-name-or-from-email-address/) created for this list.
     */
    #[JsonProperty('campaign_defaults')]
    public CreateListsRequestCampaignDefaults $campaignDefaults;

    /**
     * @var CreateListsRequestContact $contact [Contact information displayed in campaign footers](https://mailchimp.com/help/about-campaign-footers/) to comply with international spam laws.
     */
    #[JsonProperty('contact')]
    public CreateListsRequestContact $contact;
    ...
    public function __construct(
        ...
        $this->campaignDefaults = $values['campaignDefaults'];
        $this->contact = $values['contact'];
        $this->doubleOptin = $values['doubleOptin'] ?? null;
        $this->emailTypeOption = $values['emailTypeOption'];
        ...
        $this->permissionReminder = $values['permissionReminder'];
