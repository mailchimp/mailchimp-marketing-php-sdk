...
use Mailchimp\Lists\Types\UpsertMemberListsRequestLocation;
use Mailchimp\Lists\Types\UpsertMemberListsRequestMarketingPermissionsItem;
use Mailchimp\Lists\Types\UpsertMemberListsRequestMergeFieldsValueAddr1;
use Mailchimp\Core\Types\Union;
use Mailchimp\Lists\Types\UpsertMemberListsRequestStatus;
use Mailchimp\Lists\Types\UpsertMemberListsRequestStatusIfNew;
use Mailchimp\Lists\Types\UpsertMemberListsRequestTimestampOptOne;
use Mailchimp\Lists\Types\UpsertMemberListsRequestTimestampSignupOne;

class UpsertMemberListsRequest extends JsonSerializableType
{
    /**
    ...
    /**
     * @var string $emailAddress Email address for a subscriber. This value is required only if the email address is not already present on the list.
     */
    ...
    /**
     * @var ?UpsertMemberListsRequestLocation $location Subscriber location information.
     */
    #[JsonProperty('location')]
    public ?UpsertMemberListsRequestLocation $location;

    /**
     * @var ?array<UpsertMemberListsRequestMarketingPermissionsItem> $marketingPermissions The marketing permissions for the subscriber.
     */
    #[JsonProperty('marketing_permissions'), ArrayType([UpsertMemberListsRequestMarketingPermissionsItem::class])]
     ...
     */
    #[JsonProperty('merge_fields'), ArrayType(['string' => new Union(UpsertMemberListsRequestMergeFieldsValueAddr1::class, 'string', 'float')])]
    public ?array $mergeFields;

    /**
     * @var ?value-of<UpsertMemberListsRequestStatus> $status Subscriber's current status.
     */
    #[JsonProperty('status')]
    public ?string $status;

    /**
     * @var ?value-of<UpsertMemberListsRequestStatusIfNew> $statusIfNew Subscriber's status. This value is required only if the email address is not already present on the list.
     */
    #[JsonProperty('status_if_new')]
    public ?string $statusIfNew;
     ...
     * @var (
     *    string
     *   |value-of<UpsertMemberListsRequestTimestampOptOne>
     * )|null $timestampOpt
     */
     ...
     * @var (
     *    string
     *   |value-of<UpsertMemberListsRequestTimestampSignupOne>
     ...
     *   ipSignup?: ?string,
     *   language?: ?string,
     *   location?: ?UpsertMemberListsRequestLocation,
     *   marketingPermissions?: ?array<UpsertMemberListsRequestMarketingPermissionsItem>,
     *   mergeFields?: ?array<string, (
     *    UpsertMemberListsRequestMergeFieldsValueAddr1
     *   |string
     *   |float
     * )>,
     *   status?: ?value-of<UpsertMemberListsRequestStatus>,
     *   statusIfNew?: ?value-of<UpsertMemberListsRequestStatusIfNew>,
     *   tags?: ?array<string>,
     *   timestampOpt?: (
     *    string
     *   |value-of<UpsertMemberListsRequestTimestampOptOne>
    ...
    public function __construct(
        ...
        $this->statusIfNew = $values['statusIfNew'] ?? null;
