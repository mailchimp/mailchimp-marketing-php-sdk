...
use Mailchimp\Lists\Types\ListGrowthHistoryListsRequestSortField;
use Mailchimp\Lists\Types\ListGrowthHistoryListsRequestSortDir;

class ListGrowthHistoryListsRequest extends JsonSerializableType
{
    /**
    ...
    /**
     * @var ?value-of<ListGrowthHistoryListsRequestSortField> $sortField Returns files sorted by the specified field.
     */
    public ?string $sortField;

    /**
     * @var ?value-of<ListGrowthHistoryListsRequestSortDir> $sortDir Determines the order direction for sorted results.
     */
     ...
     *   count?: ?int,
     *   offset?: ?int,
     *   sortField?: ?value-of<ListGrowthHistoryListsRequestSortField>,
     *   sortDir?: ?value-of<ListGrowthHistoryListsRequestSortDir>,
     * } $values
     */
