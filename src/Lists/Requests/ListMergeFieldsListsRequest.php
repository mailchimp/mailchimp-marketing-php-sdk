...
class ListMergeFieldsListsRequest extends JsonSerializableType
{
    /**
    ...
    /**
     * @var ?string $type The merge field type.
     */
    public ?string $type;

    /**
     * @var ?bool $required Whether it's a required merge field.
     */
