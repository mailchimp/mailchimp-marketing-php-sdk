...
use Mailchimp\Lists\Types\CreateMergeFieldListsRequestOptions;
use Mailchimp\Lists\Types\CreateMergeFieldListsRequestType;

class CreateMergeFieldListsRequest extends JsonSerializableType
{
    /**
    ...
    /**
     * @var ?CreateMergeFieldListsRequestOptions $options Extra options for some merge field types.
     */
    #[JsonProperty('options')]
    public ?CreateMergeFieldListsRequestOptions $options;
    ...
    /**
     * @var value-of<CreateMergeFieldListsRequestType> $type The [type](https://mailchimp.com/developer/marketing/docs/merge-fields/#structure) for the merge field.
     */
    #[JsonProperty('type')]
    public string $type;
     ...
     * @param array{
     *   name: string,
     *   type: value-of<CreateMergeFieldListsRequestType>,
     *   defaultValue?: ?string,
     *   displayOrder?: ?int,
     *   helpText?: ?string,
     *   options?: ?CreateMergeFieldListsRequestOptions,
     *   public?: ?bool,
     *   required?: ?bool,
     *   tag?: ?string,
     * } $values
