 ...
 */
class UpdateCampaignFoldersResponseLinksItem extends JsonSerializableType
{
    /**
    ...
    /**
     * @var ?value-of<UpdateCampaignFoldersResponseLinksItemMethod> $method The HTTP method that should be used when accessing the URL defined in 'href'.
     */
    #[JsonProperty('method')]
     ...
     * @param array{
     *   href?: ?string,
     *   method?: ?value-of<UpdateCampaignFoldersResponseLinksItemMethod>,
     *   rel?: ?string,
     *   schema?: ?string,
     *   targetSchema?: ?string,
     * } $values
