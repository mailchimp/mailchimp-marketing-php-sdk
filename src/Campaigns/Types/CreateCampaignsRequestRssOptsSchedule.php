 ...
 */
class CreateCampaignsRequestRssOptsSchedule extends JsonSerializableType
{
    /**
     * @var ?CreateCampaignsRequestRssOptsScheduleDailySend $dailySend The days of the week to send a daily RSS Campaign.
     */
    #[JsonProperty('daily_send')]
    public ?CreateCampaignsRequestRssOptsScheduleDailySend $dailySend;
    ...
    /**
     * @var ?value-of<CreateCampaignsRequestRssOptsScheduleWeeklySendDay> $weeklySendDay The day of the week to send a weekly RSS Campaign.
     */
    ...
    /**
     * @param array{
     *   dailySend?: ?CreateCampaignsRequestRssOptsScheduleDailySend,
     *   hour?: ?int,
     *   monthlySendDate?: ?float,
     *   weeklySendDay?: ?value-of<CreateCampaignsRequestRssOptsScheduleWeeklySendDay>,
     * } $values
     */
