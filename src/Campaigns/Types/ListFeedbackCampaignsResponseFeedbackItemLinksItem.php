 ...
 */
class ListFeedbackCampaignsResponseFeedbackItemLinksItem extends JsonSerializableType
{
    /**
    ...
    /**
     * @var ?value-of<ListFeedbackCampaignsResponseFeedbackItemLinksItemMethod> $method The HTTP method that should be used when accessing the URL defined in 'href'.
     */
    #[JsonProperty('method')]
     ...
     * @param array{
     *   href?: ?string,
     *   method?: ?value-of<ListFeedbackCampaignsResponseFeedbackItemLinksItemMethod>,
     *   rel?: ?string,
     *   schema?: ?string,
     *   targetSchema?: ?string,
     * } $values
