 ...
 */
class UpdateCampaignsRequestRssOptsSchedule extends JsonSerializableType
{
    /**
     * @var ?UpdateCampaignsRequestRssOptsScheduleDailySend $dailySend The days of the week to send a daily RSS Campaign.
     */
    #[JsonProperty('daily_send')]
    public ?UpdateCampaignsRequestRssOptsScheduleDailySend $dailySend;
    ...
    /**
     * @var ?value-of<UpdateCampaignsRequestRssOptsScheduleWeeklySendDay> $weeklySendDay The day of the week to send a weekly RSS Campaign.
     */
    ...
    /**
     * @param array{
     *   dailySend?: ?UpdateCampaignsRequestRssOptsScheduleDailySend,
     *   hour?: ?int,
     *   monthlySendDate?: ?float,
     *   weeklySendDay?: ?value-of<UpdateCampaignsRequestRssOptsScheduleWeeklySendDay>,
     * } $values
     */
