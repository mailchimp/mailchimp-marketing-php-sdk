 ...
 */
class UpdateCampaignsRequestRecipientsSegmentOpts extends JsonSerializableType
{
    /**
    ...
    /**
     * @var ?value-of<UpdateCampaignsRequestRecipientsSegmentOptsMatch> $match Segment match type.
     */
    #[JsonProperty('match')]
    public ?string $match;
     ...
     *   match?: ?value-of<UpdateCampaignsRequestRecipientsSegmentOptsMatch>,
