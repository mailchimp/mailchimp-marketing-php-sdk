 ...
 */
class ListAuthorizedAppsResponseAppsItemLinksItem extends JsonSerializableType
{
    /**
    ...
    /**
     * @var ?value-of<ListAuthorizedAppsResponseAppsItemLinksItemMethod> $method The HTTP method that should be used when accessing the URL defined in 'href'.
     */
    #[JsonProperty('method')]
     ...
     * @param array{
     *   href?: ?string,
     *   method?: ?value-of<ListAuthorizedAppsResponseAppsItemLinksItemMethod>,
     *   rel?: ?string,
     *   schema?: ?string,
     *   targetSchema?: ?string,
     * } $values
