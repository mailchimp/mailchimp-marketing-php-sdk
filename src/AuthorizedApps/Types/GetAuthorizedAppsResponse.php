 ...
 * An authorized app.
 */
class GetAuthorizedAppsResponse extends JsonSerializableType
{
    /**
     * @var ?array<GetAuthorizedAppsResponseLinksItem> $links A list of link types and descriptions for the API schema documents.
     */
    #[JsonProperty('_links'), ArrayType([GetAuthorizedAppsResponseLinksItem::class])]
    public ?array $links;
    ...
    /**
     * @param array{
     *   links?: ?array<GetAuthorizedAppsResponseLinksItem>,
     *   description?: ?string,
     *   id?: ?int,
     *   name?: ?string,
     *   users?: ?array<string>,
