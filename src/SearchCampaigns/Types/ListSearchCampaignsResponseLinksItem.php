 ...
 */
class ListSearchCampaignsResponseLinksItem extends JsonSerializableType
{
    /**
    ...
    /**
     * @var ?value-of<ListSearchCampaignsResponseLinksItemMethod> $method The HTTP method that should be used when accessing the URL defined in 'href'.
     */
    #[JsonProperty('method')]
     ...
     * @param array{
     *   href?: ?string,
     *   method?: ?value-of<ListSearchCampaignsResponseLinksItemMethod>,
     *   rel?: ?string,
     *   schema?: ?string,
     *   targetSchema?: ?string,
     * } $values
