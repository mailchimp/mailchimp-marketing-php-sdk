 ...
 */
class CreateActionVerifyVerifiedDomainsResponse extends JsonSerializableType
{
    /**
    ...
    /**
     * @var ?value-of<CreateActionVerifyVerifiedDomainsResponseStatus> $status The Domain's current status.
     */
    #[JsonProperty('status')]
     ...
     *   status?: ?value-of<CreateActionVerifyVerifiedDomainsResponseStatus>,
