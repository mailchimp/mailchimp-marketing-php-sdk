 ...
 */
class ListVerifiedDomainsResponseDomainsItem extends JsonSerializableType
{
    /**
    ...
    /**
     * @var ?value-of<ListVerifiedDomainsResponseDomainsItemStatus> $status The Domain's current status.
     */
    #[JsonProperty('status')]
     ...
     *   status?: ?value-of<ListVerifiedDomainsResponseDomainsItemStatus>,
