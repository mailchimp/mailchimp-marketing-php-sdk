 ...
 */
class GetVerifiedDomainsResponse extends JsonSerializableType
{
    /**
    ...
    /**
     * @var ?value-of<GetVerifiedDomainsResponseStatus> $status The Domain's current status.
     */
    #[JsonProperty('status')]
     ...
     *   status?: ?value-of<GetVerifiedDomainsResponseStatus>,
