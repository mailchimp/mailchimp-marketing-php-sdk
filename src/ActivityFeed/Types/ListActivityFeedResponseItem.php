 ...
 */
class ListActivityFeedResponseItem extends JsonSerializableType
{
    /**
    ...
    /**
     * @var ?value-of<ListActivityFeedResponseItemMethod> $method The HTTP method that should be used when accessing the URL defined in 'href'.
     */
    #[JsonProperty('method')]
     ...
     * @param array{
     *   href?: ?string,
     *   method?: ?value-of<ListActivityFeedResponseItemMethod>,
     *   rel?: ?string,
     *   schema?: ?string,
     *   targetSchema?: ?string,
     * } $values
