 ...
 */
class ListFileManagerResponseItem extends JsonSerializableType
{
    /**
    ...
    /**
     * @var ?value-of<ListFileManagerResponseItemMethod> $method The HTTP method that should be used when accessing the URL defined in 'href'.
     */
    #[JsonProperty('method')]
     ...
     * @param array{
     *   href?: ?string,
     *   method?: ?value-of<ListFileManagerResponseItemMethod>,
     *   rel?: ?string,
     *   schema?: ?string,
     *   targetSchema?: ?string,
     * } $values
