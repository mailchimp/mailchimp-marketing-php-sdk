 ...
 */
class CreateFolderFileManagerResponseLinksItem extends JsonSerializableType
{
    /**
    ...
    /**
     * @var ?value-of<CreateFolderFileManagerResponseLinksItemMethod> $method The HTTP method that should be used when accessing the URL defined in 'href'.
     */
    #[JsonProperty('method')]
     ...
     * @param array{
     *   href?: ?string,
     *   method?: ?value-of<CreateFolderFileManagerResponseLinksItemMethod>,
     *   rel?: ?string,
     *   schema?: ?string,
     *   targetSchema?: ?string,
     * } $values
