 ...
 */
class ListFolderFilesFileManagerResponse extends JsonSerializableType
{
    /**
     * @var ?array<ListFolderFilesFileManagerResponseLinksItem> $links A list of link types and descriptions for the API schema documents.
     */
    #[JsonProperty('_links'), ArrayType([ListFolderFilesFileManagerResponseLinksItem::class])]
    public ?array $links;
    ...
    /**
     * @param array{
     *   links?: ?array<ListFolderFilesFileManagerResponseLinksItem>,
