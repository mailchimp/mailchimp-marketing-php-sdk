 ...
 */
class CreateFolderFileManagerResponse extends JsonSerializableType
{
    /**
     * @var ?array<CreateFolderFileManagerResponseLinksItem> $links A list of link types and descriptions for the API schema documents.
     */
    #[JsonProperty('_links'), ArrayType([CreateFolderFileManagerResponseLinksItem::class])]
    public ?array $links;
    ...
    /**
     * @param array{
     *   links?: ?array<CreateFolderFileManagerResponseLinksItem>,
     *   createdAt?: ?DateTime,
     *   createdBy?: ?string,
     *   fileCount?: ?int,
     *   id?: ?int,
