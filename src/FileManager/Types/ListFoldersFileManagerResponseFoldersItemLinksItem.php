 ...
 */
class ListFoldersFileManagerResponseFoldersItemLinksItem extends JsonSerializableType
{
    /**
    ...
    /**
     * @var ?value-of<ListFoldersFileManagerResponseFoldersItemLinksItemMethod> $method The HTTP method that should be used when accessing the URL defined in 'href'.
     */
    #[JsonProperty('method')]
     ...
     * @param array{
     *   href?: ?string,
     *   method?: ?value-of<ListFoldersFileManagerResponseFoldersItemLinksItemMethod>,
     *   rel?: ?string,
     *   schema?: ?string,
     *   targetSchema?: ?string,
     * } $values
