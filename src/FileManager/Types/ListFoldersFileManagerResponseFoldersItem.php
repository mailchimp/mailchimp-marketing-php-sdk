 ...
 */
class ListFoldersFileManagerResponseFoldersItem extends JsonSerializableType
{
    /**
     * @var ?array<ListFoldersFileManagerResponseFoldersItemLinksItem> $links A list of link types and descriptions for the API schema documents.
     */
    #[JsonProperty('_links'), ArrayType([ListFoldersFileManagerResponseFoldersItemLinksItem::class])]
    public ?array $links;
    ...
    /**
     * @param array{
     *   links?: ?array<ListFoldersFileManagerResponseFoldersItemLinksItem>,
     *   createdAt?: ?DateTime,
     *   createdBy?: ?string,
     *   fileCount?: ?int,
     *   id?: ?int,
