 ...
 */
class UpdateFolderFileManagerResponse extends JsonSerializableType
{
    /**
     * @var ?array<UpdateFolderFileManagerResponseLinksItem> $links A list of link types and descriptions for the API schema documents.
     */
    #[JsonProperty('_links'), ArrayType([UpdateFolderFileManagerResponseLinksItem::class])]
    public ?array $links;
    ...
    /**
     * @param array{
     *   links?: ?array<UpdateFolderFileManagerResponseLinksItem>,
     *   createdAt?: ?DateTime,
     *   createdBy?: ?string,
     *   fileCount?: ?int,
     *   id?: ?int,
