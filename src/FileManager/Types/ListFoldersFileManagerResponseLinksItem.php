 ...
 */
class ListFoldersFileManagerResponseLinksItem extends JsonSerializableType
{
    /**
    ...
    /**
     * @var ?value-of<ListFoldersFileManagerResponseLinksItemMethod> $method The HTTP method that should be used when accessing the URL defined in 'href'.
     */
    #[JsonProperty('method')]
     ...
     * @param array{
     *   href?: ?string,
     *   method?: ?value-of<ListFoldersFileManagerResponseLinksItemMethod>,
     *   rel?: ?string,
     *   schema?: ?string,
     *   targetSchema?: ?string,
     * } $values
