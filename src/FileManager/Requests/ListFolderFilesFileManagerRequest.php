...
use Mailchimp\FileManager\Types\ListFolderFilesFileManagerRequestSortField;
use Mailchimp\FileManager\Types\ListFolderFilesFileManagerRequestSortDir;

class ListFolderFilesFileManagerRequest extends JsonSerializableType
{
    /**
    ...
    /**
     * @var ?value-of<ListFolderFilesFileManagerRequestSortField> $sortField Returns files sorted by the specified field.
     */
    public ?string $sortField;

    /**
     * @var ?value-of<ListFolderFilesFileManagerRequestSortDir> $sortDir Determines the order direction for sorted results.
     */
     ...
     *   sortField?: ?value-of<ListFolderFilesFileManagerRequestSortField>,
     *   sortDir?: ?value-of<ListFolderFilesFileManagerRequestSortDir>,
     * } $values
     */
