 ...
 */
class ListAdviceReportsResponseAdviceItemLinksItem extends JsonSerializableType
{
    /**
    ...
    /**
     * @var ?value-of<ListAdviceReportsResponseAdviceItemLinksItemMethod> $method The HTTP method that should be used when accessing the URL defined in 'href'.
     */
    #[JsonProperty('method')]
     ...
     * @param array{
     *   href?: ?string,
     *   method?: ?value-of<ListAdviceReportsResponseAdviceItemLinksItemMethod>,
     *   rel?: ?string,
     *   schema?: ?string,
     *   targetSchema?: ?string,
     * } $values
