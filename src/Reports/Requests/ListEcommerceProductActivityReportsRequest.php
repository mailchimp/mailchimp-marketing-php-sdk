...
use Mailchimp\Reports\Types\ListEcommerceProductActivityReportsRequestSortField;

class ListEcommerceProductActivityReportsRequest extends JsonSerializableType
{
    /**
    ...
    /**
     * @var ?value-of<ListEcommerceProductActivityReportsRequestSortField> $sortField Returns files sorted by the specified field.
     */
     ...
     *   count?: ?int,
     *   offset?: ?int,
     *   sortField?: ?value-of<ListEcommerceProductActivityReportsRequestSortField>,
     * } $values
     */
