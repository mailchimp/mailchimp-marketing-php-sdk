...
namespace Mailchimp\Core\Json;

use DateTime;
use Exception;
use JsonException;
use Mailchimp\Core\Types\Constant;
...
class JsonDeserializer
{
    ...
    {
        // PHP's DateTime constructor treats an empty string as "construct for the
        ...
        if (trim($datetime) === '') {
            throw new JsonException("Cannot create DateTime from an empty string");
        }
        try {
