 ...
 */
class CreateStoreOrderEcommerceRequestBillingAddress extends JsonSerializableType
{
    /**
     ...
     *    float
     *   |string
     * )|null $latitude The latitude for the billing address location.
     */
     ...
     *    float
     *   |string
     * )|null $longitude The longitude for the billing address location.
     */
    #[JsonProperty('longitude'), Union('float', 'string', 'null')]
    public float|string|null $longitude;

    /**
     * @var ?string $name The name associated with the billing address.
     */
    #[JsonProperty('name')]
    public ?string $name;
    ...
    /**
     * @var ?string $provinceCode The two-letter code for the province in the billing address.
     */
