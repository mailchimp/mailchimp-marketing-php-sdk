 ...
 */
class UpdateStoreProductImageEcommerceResponseLinksItem extends JsonSerializableType
{
    /**
    ...
    /**
     * @var ?value-of<UpdateStoreProductImageEcommerceResponseLinksItemMethod> $method The HTTP method that should be used when accessing the URL defined in 'href'.
     */
    #[JsonProperty('method')]
     ...
     * @param array{
     *   href?: ?string,
     *   method?: ?value-of<UpdateStoreProductImageEcommerceResponseLinksItemMethod>,
     *   rel?: ?string,
     *   schema?: ?string,
     *   targetSchema?: ?string,
     * } $values
