 ...
 */
class CreateStoreOrderEcommerceRequestShippingAddress extends JsonSerializableType
{
    /**
    ...
    /**
     * @var ?string $company The company associated with the shipping address.
     */
    #[JsonProperty('company')]
    public ?string $company;

    /**
     * @var ?string $country The country in the shipping address.
     */
    ...
    /**
     * @var ?string $postalCode The postal or zip code in the shipping address.
     */
    ...
    /**
     * @var ?string $provinceCode The two-letter code for the province or state in the shipping address.
     */
