 ...
 */
class ListStoreProductImagesEcommerceResponseImagesItemLinksItem extends JsonSerializableType
{
    /**
    ...
    /**
     * @var ?value-of<ListStoreProductImagesEcommerceResponseImagesItemLinksItemMethod> $method The HTTP method that should be used when accessing the URL defined in 'href'.
     */
    #[JsonProperty('method')]
     ...
     * @param array{
     *   href?: ?string,
     *   method?: ?value-of<ListStoreProductImagesEcommerceResponseImagesItemLinksItemMethod>,
     *   rel?: ?string,
     *   schema?: ?string,
     *   targetSchema?: ?string,
     * } $values
