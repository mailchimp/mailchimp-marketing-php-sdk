...
class ListStoreCustomersEcommerceRequest extends JsonSerializableType
{
    /**
    ...
    /**
     * @var ?string $emailAddress Restrict the response to customers with the email address.
     */
