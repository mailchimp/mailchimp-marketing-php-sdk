...
use Mailchimp\Ecommerce\Types\CreateStoreCustomerEcommerceRequestAddress;
use Mailchimp\Core\Json\JsonProperty;
use Mailchimp\Core\Types\Union;

class CreateStoreCustomerEcommerceRequest extends JsonSerializableType
{
    /**
     * @var ?CreateStoreCustomerEcommerceRequestAddress $address The customer's address.
     */
    #[JsonProperty('address')]
    public ?CreateStoreCustomerEcommerceRequestAddress $address;
     ...
     *   id: string,
     *   optInStatus: bool,
     *   address?: ?CreateStoreCustomerEcommerceRequestAddress,
     *   company?: ?string,
     *   emailAddress?: ?string,
     *   firstName?: ?string,
     *   lastName?: ?string,
    ...
    public function __construct(
        ...
        $this->optInStatus = $values['optInStatus'];
