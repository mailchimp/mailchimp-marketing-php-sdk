 ...
 */
class CreateAudienceContactRequestSmsChannelMarketingConsent extends JsonSerializableType
{
    /**
     * @var ?CreateAudienceContactRequestSmsChannelMarketingConsentSource $source The source from which the parent's entity was created.
     */
    #[JsonProperty('source')]
    public ?CreateAudienceContactRequestSmsChannelMarketingConsentSource $source;

    /**
     * @var ?value-of<CreateAudienceContactRequestSmsChannelMarketingConsentStatus> $status The contact's SMS marketing consent status. Use `confirmed` for double opt-in audiences, `consented` for single opt-in audiences.
     */
    #[JsonProperty('status')]
    ...
    /**
     * @param array{
     *   source?: ?CreateAudienceContactRequestSmsChannelMarketingConsentSource,
     *   status?: ?value-of<CreateAudienceContactRequestSmsChannelMarketingConsentStatus>,
     *   capturedAt?: ?DateTime,
     * } $values
     */
