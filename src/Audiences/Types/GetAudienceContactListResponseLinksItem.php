 ...
 */
class GetAudienceContactListResponseLinksItem extends JsonSerializableType
{
    /**
    ...
    /**
     * @var ?value-of<GetAudienceContactListResponseLinksItemMethod> $method The HTTP method that should be used when accessing the URL defined in 'href'.
     */
    #[JsonProperty('method')]
     ...
     * @param array{
     *   href?: ?string,
     *   method?: ?value-of<GetAudienceContactListResponseLinksItemMethod>,
     *   rel?: ?string,
     *   schema?: ?string,
     *   targetSchema?: ?string,
     * } $values
