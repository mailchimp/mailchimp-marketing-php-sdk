 ...
 */
class GetTemplateFoldersResponseLinksItem extends JsonSerializableType
{
    /**
    ...
    /**
     * @var ?value-of<GetTemplateFoldersResponseLinksItemMethod> $method The HTTP method that should be used when accessing the URL defined in 'href'.
     */
    #[JsonProperty('method')]
     ...
     * @param array{
     *   href?: ?string,
     *   method?: ?value-of<GetTemplateFoldersResponseLinksItemMethod>,
     *   rel?: ?string,
     *   schema?: ?string,
     *   targetSchema?: ?string,
     * } $values
