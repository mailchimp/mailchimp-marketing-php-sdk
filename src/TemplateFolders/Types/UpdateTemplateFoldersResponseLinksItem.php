 ...
 */
class UpdateTemplateFoldersResponseLinksItem extends JsonSerializableType
{
    /**
    ...
    /**
     * @var ?value-of<UpdateTemplateFoldersResponseLinksItemMethod> $method The HTTP method that should be used when accessing the URL defined in 'href'.
     */
    #[JsonProperty('method')]
     ...
     * @param array{
     *   href?: ?string,
     *   method?: ?value-of<UpdateTemplateFoldersResponseLinksItemMethod>,
     *   rel?: ?string,
     *   schema?: ?string,
     *   targetSchema?: ?string,
     * } $values
