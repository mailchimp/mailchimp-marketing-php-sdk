 ...
 */
class ListTemplateFoldersResponseFoldersItemLinksItem extends JsonSerializableType
{
    /**
    ...
    /**
     * @var ?value-of<ListTemplateFoldersResponseFoldersItemLinksItemMethod> $method The HTTP method that should be used when accessing the URL defined in 'href'.
     */
    #[JsonProperty('method')]
     ...
     * @param array{
     *   href?: ?string,
     *   method?: ?value-of<ListTemplateFoldersResponseFoldersItemLinksItemMethod>,
     *   rel?: ?string,
     *   schema?: ?string,
     *   targetSchema?: ?string,
     * } $values
