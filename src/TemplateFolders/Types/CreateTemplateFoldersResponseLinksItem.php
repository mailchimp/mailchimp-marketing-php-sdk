 ...
 */
class CreateTemplateFoldersResponseLinksItem extends JsonSerializableType
{
    /**
    ...
    /**
     * @var ?value-of<CreateTemplateFoldersResponseLinksItemMethod> $method The HTTP method that should be used when accessing the URL defined in 'href'.
     */
    #[JsonProperty('method')]
     ...
     * @param array{
     *   href?: ?string,
     *   method?: ?value-of<CreateTemplateFoldersResponseLinksItemMethod>,
     *   rel?: ?string,
     *   schema?: ?string,
     *   targetSchema?: ?string,
     * } $values
